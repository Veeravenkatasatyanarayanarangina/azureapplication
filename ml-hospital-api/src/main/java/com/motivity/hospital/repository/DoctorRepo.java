...
public interface DoctorRepo extends CrudRepository<Doctors, Integer>{
	...
	@Transactional
    @Modifying
    @Query("update Doctors d set d.firstname=:firstname,d.lastname=:lastname,d.email=:email,d.department=:department,d.phoneno=:phoneno,d.address=:address,d.exp=:exp where d.id=:id")
    public int updateDoctor(String firstname,String lastname,String email,String department,String phoneno,String address,String exp,int id);
	@Transactional
    @Modifying
