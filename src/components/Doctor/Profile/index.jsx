...
const Profile = () => {
  ...
  const onUpdate = (event) => {
    ...
    axios.post(baseURL + "upadateDoctor", editDoctorData).then((response) => {
              ...
              <div className='card-body p-5'>
                <form className='row g-3' onSubmit={onUpdate}>
                  <div className='col-md-6'>
                    <label for='eDoctorFirstName' className='form-label'>
                      First Name
                    </label>
                    <input
                      type='text'
                  ...
                  <div className='col-md-6'>
                    <label for='eDoctorLastName' className='form-label'>
                      Last Name
                    </label>
                    <input
                      type='text'
                  ...
                  <div className='col-md-6'>
                    <label for='eDoctorEmail' className='form-label'>
                      Email
                    </label>
                    <input
                      type='email'
                  ...
                  <div className='col-md-6'>
                    <label for='eDoctorPhoneNo' className='form-label'>
                      Mobile no
                    </label>
                    <input
                      type='tel'
                  ...
                  <div className='col-md-6'>
                    <label for='eDoctorExp' className='form-label'>
                      Exiperience
                    </label>
                    <input
                      type='number'
