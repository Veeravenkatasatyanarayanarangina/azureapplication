...
const ApplyAppointment = () => {
  ...
  const [appointment, setAppointment] = useState({
    ...
    patientGender: currentPatient.patient_gender,
    patientAge: currentPatient.patient_age,
  ...
  const onApply = (event) => {
    ...
    axios
      .post(`${baseURL}insertAppointment`, appointment)
      .then((response) => {
                ...
                <form className='row g-3' onSubmit={onApply}>
                  ...
                  <div className='col-md-12'>
                    ...
                    <input
                      ...
                      className='form-control'
                      id='patientGender'
                      value={currentPatient.patient_gender}
                      name='patientGender'
                      readOnly
                      disabled
                    />
